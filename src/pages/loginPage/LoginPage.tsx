...
export const LoginPage = ({ handleGetCartItems }: any) => {
      ...
      <div className="pt-16">
        ...
        >
          ...
          <div className="w-full">
            ...
            <input
              className={`w-full border  ${
                errors.password ? ` border-red` : ` border-slate-400`
              }   outline-none`}
              type="password"
              id="password"
              {...register("password")}
          ...
          <button className=" w-full rounded-xl  bg-green-400 px-5 py-2  text-sm hover:bg-green-600">
            Submit
          </button>
        </form>
      </div>
